...
function getStudent(e) {
  ...
  fetch("../students/" + no)
    ...
    .then((result) => {
      ...
      if (student.photo) {
        document.querySelector("#f-photo-origin").href = `https://kr.object.ncloudstorage.com/ncp08-bucket-0628-member-photo-2/${student.photo}`;
        document.querySelector("#f-photo").src = `https://xzydglxl3606.edge.naverncp.com/AZ8FPX7POW/${student.photo}?type=f&w=80&h=80&ttype=jpg`;
